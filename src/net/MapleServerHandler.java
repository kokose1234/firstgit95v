...
public class MapleServerHandler extends IoHandlerAdapter {
    ...
    public void sessionOpened(IoSession session) {
        ...
        session.write(CLogin.getHello(ServerConstants.VERSION, ivSend, ivRecv));
    ...
    public void messageReceived(IoSession session, Object message) {
        ...
        if ((packetHandler == null && packetId != 0x0C) || packetId == 0x1C) {
            System.out.println("[R] " + HexTool.toString(content));
            System.out.println();
        }
