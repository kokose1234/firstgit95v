...
public final class RangedAttackHandler extends AbstractDealDamageHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (attack.skill == Viper.ENERGY_ORB || attack.skill == Striker.SPARK || attack.skill == Shadower.TAUNT || attack.skill == NightLord.TAUNT) {
            ...
            if (projectile != 0 || soulArrow || attack.skill == 11101004 || attack.skill == 15111007 || attack.skill == 14101006) {
                ...
                switch (attack.skill) {
                    ...
                    case 13111002: // KoC Hurricane
                        packet = MaplePacketCreator.rangedAttack(player, attack.skill, attack.skilllevel, attack.rangedirection, attack.numAttackedAndDamage, attack.charge, attack.allDamage, attack.speed, attack.direction, attack.display);
                        break;
                    default:
                        packet = MaplePacketCreator.rangedAttack(player, attack.skill, attack.skilllevel, attack.stance, attack.numAttackedAndDamage, attack.charge, attack.allDamage, attack.speed, attack.direction, attack.display);
                        break;
                }
                ...
                if ((player.getSkillLevel(SkillFactory.getSkill(NightWalker.VANISH)) > 0 || player.getSkillLevel(SkillFactory.getSkill(WindBreaker.WIND_WALK)) > 0) && player.getBuffedValue(MapleBuffStat.DARKSIGHT) != null && attack.numAttacked > 0 && player.getBuffSource(MapleBuffStat.DARKSIGHT) != 9101004) {
