...
public final class MoveLifeHandler extends AbstractMovementPacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        final boolean bCheatResult = (skillByte & 0xF) != 0;
        ...
        if (toUse != null) {
            c.announce(MaplePacketCreator.moveMonsterResponse(objectid, moveid, monster.getMp(), bCheatResult, toUse.getSkillId(), toUse.getSkillLevel()));
        } else {
            c.announce(MaplePacketCreator.moveMonsterResponse(objectid, moveid, monster.getMp(), bCheatResult));
        }
        if (bCheatResult) {
