...
import tools.packet.WitchtowerPacket;
...
public class ReactorActionManager extends AbstractPlayerInteraction {
    ...
    public void updateWitchtowerScore(int key) {
        getPlayer().getMap().startMapEffect("열쇠를 " + key + "개째 획득하였습니다.", 5120030, 3000);
        //Fake destroy
        reactor.getMap().broadcastMessage(MaplePacketCreator.destroyReactor(reactor));
        //
        c.announce(WitchtowerPacket.WitchtowerScoreUpdate(key));
